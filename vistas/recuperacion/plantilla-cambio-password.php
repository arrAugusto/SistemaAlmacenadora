...
<div style="width:100%; background:#eee; position:relative; font-family:sans-serif; padding-bottom:40px">
	...
	<div style="position:relative; margin:auto; width:800px; background:white; padding:20px">
		...
		<h4 style="font-weight:100; color:#999; padding:0 20px"><strong>Su nueva contraseña: </strong>3dfsdf42eaf</h4>

		<a href="http://localhost/almacenadorasunidas/" target="_blank" style="text-decoration:none">
