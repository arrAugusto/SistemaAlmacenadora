                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col-4 mt-2">
                                <button type="button" class="btn btn-outline-success btn-lg btn-block"  estadoRep="4">GENERAR HISTORIAL DE CHASIS EXCEL <i class="fa fa-file-excel-o"></i></button>
                            </div>
                            <div class="col-4 mt-2">
                                <button type="button" class="btn btn-outline-primary btn-lg btn-block btnGuardarLoteChasisConta">REPORTAR LOTE SELECCIONADO </button>
                            </div>                            
                           <div class="col-4 mt-2">
                            <label>Calculado hasta :</label>
                            <div class="input-group input-group">
                                <input type="text" id="dateTime" class="form-control">
                                <input type="hidden" id="hiddenDateTime" value="2020-11-30 14:19:22">
                            ...
                            <div class="col-12 mt-5">
                                <table id="tbHistChasVehSinConta" role="grid" class="table  dt-responsive table-striped table-hover table-sm">
                                    <thead>
                                        <tr>
