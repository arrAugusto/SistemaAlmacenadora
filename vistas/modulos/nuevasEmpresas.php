        ...
        <form role="form" method="post" enctype="multipart/form-data">
          <div class="row">
            <div class="col-6 mt-4">
              ...
              <input type="text" class="form-control is-invalid" id="txtNewNit" name="txtNewNit" placeholder="Ejemplo : 37315452" value="" required autocomplete="off" />
            </div>
            <div class="col-6 mt-4">
              <label>Nombre Empresa</label>
              <input type="text" class="form-control is-invalid" id="txtNewNombre" name="txtNewNombre" placeholder="Ejemplo : MIEMPRESA, S.A." value="" required  autocomplete="off" />
            </div>
            <div class="col-6 mt-4">
              <label>Establecimiento</label>
              <input type="text" class="form-control is-invalid" id="establecimiento" name="establecimiento" placeholder="Ejemplo : ALGESA" value="" required  autocomplete="off" />
            </div>            
            <div class="col-6 mt-4">
              <label>Dirección Empresa</label>
              <input type="text" class="form-control is-invalid" id="txtNewDireccion" name="txtNewDireccion" placeholder="Ejemplo : 5A CALLE 10-52 ZONA 7" value="" required  autocomplete="off" />
            </div>
            <div class="col-6 mt-4">
              <label>Telefono Empresa</label>
              <input type="text" class="form-control is-invalid" id="txtNewTelefono" name="txtNewTelefono" placeholder="555-1212" required value=""  autocomplete="off" />
            </div>
            <div class="col-6 mt-4">
              <label>Email</label>
      ...
      <div class="modal-body">
        <form role="form" method="post" enctype="multipart/form-data">
          <div class="row">
            <div class="col-6 mt-4">
              <label>Nit Empresa</label>
              <input type="text" class="form-control is-invalid" id="txtNewNitEdit" name="txtNewNitEdit" placeholder="Ejemplo : 37315452" value=""  autocomplete="off" />
            </div>
            <div class="col-6 mt-4">
              <label>Nombre Empresa</label>
              <input type="text" class="form-control is-invalid" id="txtNewNombreEdit" name="txtNewNombreEdit" placeholder="Ejemplo : MIEMPRESA, S.A." value=""  autocomplete="off" />
            </div>
            <div class="col-6 mt-4">
              <label>Establecimiento</label>
              <input type="text" class="form-control is-invalid" id="establecimientoEdit" name="establecimientoEdit" placeholder="Ejemplo : ALGESA" value="" required  autocomplete="off" />
            </div>              
            <div class="col-6 mt-4">
              <label>Dirección Empresa</label>
              <input type="text" class="form-control is-invalid" id="txtNewDireccionEdit" name="txtNewDireccionEdit" placeholder="Ejemplo : 5A CALLE 10-52 ZONA 7" value=""  autocomplete="off" />
            </div>
            <div class="col-6 mt-4">
              <label>Telefono Empresa</label>
              <input type="text" class="form-control is-invalid" id="txtNewTelefonoEdit" name="txtNewTelefonoEdit" placeholder="555-1212" value=""  autocomplete="off" />
            </div>
            <div class="col-6 mt-4">
              <label>Email</label>
              <div class="input-group mb-3">
