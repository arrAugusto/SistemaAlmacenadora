                        ...
                        <div class="card-body box-profile">
                            <div class="text-center">
                                ...
                                <ul class="list-group list-group-unbordered mb-3">
                                    ...
                                    <button type="button" class="btn btn-danger btnCambioPassWord" data-toggle="modal" data-target="#changePassWord">Contraseña</button>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="col-md-12">
                    ...
                    <div class="card card-info">
                        <div class="card-header">
                            <h3 class="card-title">Cambio de Contraseñas</h3>
                        </div>
                        <!--campos formularios -->
                            ...
                            <div class="form-horizontal">
                                <div class="card-body">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-12">
                                            <label>Usuario a cambiar contraseña</label>
                                            <div class="form-group has-feedback">
                                                <input type="text" class="form-control" id="colabora" placeholder="Nueva Contraseña" id="nuevacontra" name="nuevacontra" value="" required>
                                            </div>
                                        </div>
                                    ...
                                    <div class="card-footer">
                                        <div class="btn-group">
                                            <button type="button" class="btn btn-primary btnChangePass">Cambiar Contraseñas</button>
