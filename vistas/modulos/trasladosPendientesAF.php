                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col-4 mt-2">
                                <button type="button" class="btn btn-outline-danger btn-lg btn-block btnRepVehNew"  estadoRep="<?php echo $_SESSION["idDeBodega"]; ?>">GENERAR REPORTE DE VEHÍCULOS <i class="fa fa-file-pdf-o"></i></button>
                            </div>
                            <div class="col-4 mt-2">
