...
<span aria-hidden="true">&times;</span>
    ...
    ';
                        ...
                        <div class="col-12 mt-4">
                            <table id="tablas" role="grid" class="table dt-responsive nowrap table-striped table-bordered table-sm" cellspacing="0" >
                                <thead>
                                    <tr>
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-footer" id="divButtonPase">
                <button type="button" class="btn btn-primary btnImprimirRecibo" id="btnCalculoAlm" data-dismiss="modal">Confirmar datos <i class="far fa-check-circle"></i></div></button>
        </div>
    </div>
</div>
</div>
