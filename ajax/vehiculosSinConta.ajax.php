...
class historialIngresosFiscales {
    ...
    public function ajaxMostrarTableIngHistoria() {
        ...
        $respuesta = ModeloHistorialIngresos::mdlMostrarTableIngHistoria($sp, $estado, $valor);
        ...
        if ($respuesta !== null || $respuesta !== NULL) {
            if ($respuesta != "SD") {
                ...
                foreach ($respuesta as $key => $value) {
                    ...
                    $button = "<button type='button' class='btn btn-outline-dark btn-sm btnContaChasTra' idChasisConta=".$value["idTrasChas"]." estado=0><i class='fa fa-close'></i></button>";
