...
require_once "../controlador/activarTarifa.controlador.php";
require_once "../modelo/activarTarifas.modelo.php";
...
class AjaxNuevaTarifa {
    ...
    public function AjaxConsultaServicios() {
        ...
        $valor = $valorNit;
        $respuesta = ControladorActivarTarifa::ctrActivarTarifa($valor);
        echo json_encode($respuesta);
    }
    ...
    public function ajaxMostrarUsuarios() {
        ...
        $tabla = "USUARIOS";
        $item = "id";
        $respuesta = ControladorActivarParaCobro::ctrActivarParaCobro($tabla, $valor, $item);
        echo json_encode($respuesta);
    }
...
if (isset($_POST["idOtroServicios"])) {
    ...
    $segundaFase = new AjaxNuevaTarifa();
